...
/**
 * A class which purpose is to test the {@link ArrayIndexedCollection} and the
 * {@link LinkedListIndexedCollection} designed in the
 * {@link hr.fer.zemris.java.custom.collections} package.
 * 
 * @author Ivan Anić
 * @version 1.0
 */
