 ...
 * which gets a parameter from the temporary parameter list from the
 * {@linkplain RequestContext} instance and pushes it onto the stack.
 * 
 * @author Ivan Anić
 * @version 1.0
 */
public class FunctionTParamGet extends AbstractContextFunction {

	@Override
	public void execute(Stack<String> stack, RequestContext context) {
		String defValue = stack.pop();
		String value = context.getTemporaryParameter(stack.pop());
