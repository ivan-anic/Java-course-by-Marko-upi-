...
public class RayCasterParallel {
	...
	private static IRayTracerProducer getIRayTracerProducer() {
		return new IRayTracerProducer() {
			...
			public void produce(Point3D eye, Point3D view, Point3D viewUp,
				...
				// Point3D screenPoint = getScreenPoint(x, y, screenCorner,
				// xAxis, yAxis,
				...
				threadPool
						.invoke(new TracingAction(eye, horizontal, vertical, width, height, 
								0, height - 1, xAxis, yAxis, screenCorner, scene, red, green, blue ));
	...
	public static class TracingAction extends RecursiveAction {
		...
		public TracingAction(Point3D eye, double horizontal, double vertical, int width, int height, int i, int j,
		...
		public void compute() {
			...
			invokeAll(
					new PosaoIzracuna(reMin, reMax, imMin, imMax, width, height, yMin, yMin + (yMax - yMin) / 2, m,
							data),
					new PosaoIzracuna(reMin, reMax, imMin, imMax, width, height, yMin + (yMax - yMin) / 2 + 1, yMax, m,
							data));
		}

		public void computeDirect() {
			// Otkomentirati sljedeći redak da se vidi kako je napravljena
			// dekompozicija:
